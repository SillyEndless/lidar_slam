                                 ...
                                 int color = 0)
{
    ...
    m.header.frame_id = "map";//rviz里面的Fixed Frame的名字改成这个
...
int main(int argc, char **argv)
{
    ...
    std::string VertexPath = "/home/elliott/Documents/Lslam/LSSLAMProject/src/ls_slam/data/test_quadrat-v.dat";
    std::string EdgePath = "/home/elliott/Documents/Lslam/LSSLAMProject/src/ls_slam/data/test_quadrat-e.dat";
